...
allHrsArray.forEach((b) => b.style.border = "1px solid tomato")
// Change the background of all the hr to "antiquewhite" using for of loop.
allHrsArray.forEach((b) => b.style.backgroundColor = "antiquewhite")
// Change the 'border-radius' of all the hr to "5px" using array.
allHrsArray.forEach((b) => b.style.borderRadius = "5px")
...
img.forEach((e) => e.style.border = `2px solid purple`)
// Hide the box number 17 (last box).
let box = document.querySelector('.seventeen')
box.style.display = "none"

// Change the border of all the hr element from solid to dashed type
allHrsArray.forEach((b) => b.style.border = "1px dashed tomato")
...
document.body.style.background = "bisquie"
